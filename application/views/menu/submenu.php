...
<!-- Modal -->
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/submenu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="ikon" name="ikon" placeholder="Icon">
                    </div>
                    <div class="form-group">
